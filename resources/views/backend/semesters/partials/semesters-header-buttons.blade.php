<!--Action Button-->
@if( Active::checkUriPattern( 'admin/semesters' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.semesters.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.semesters.all' ) }}
            </a>
        </li>
        @permission( 'create-semester' )
            <li>
                <a href="{{ route( 'admin.semesters.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.semesters.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
