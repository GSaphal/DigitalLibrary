<!--Action Button-->
@if( Active::checkUriPattern( 'admin/subjects' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.subjects.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.subjects.all' ) }}
            </a>
        </li>
        @permission( 'create-subject' )
            <li>
                <a href="{{ route( 'admin.subjects.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.subjects.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
