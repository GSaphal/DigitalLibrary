...
return [
	...
	"semesters" => [
	"already_exists" => "That Semester already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Semester. Please try again.",
	"delete_error" => "There was a problem deleting this Semester. Please try again.",
	"not_found" => "That Semester does not exist.",
	"update_error" => "There was a problem updating this Semester. Please try again.",
	],
	"subjects" => [
	"already_exists" => "That Subject already exists. Please choose a different name.",
	...
	"not_found" => "That Subject does not exist.",
	"update_error" => "There was a problem updating this Subject. Please try again.",
	],
	"semesterhassubjects" => [
	"already_exists" => "That SemesterHasSubject already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this SemesterHasSubject. Please try again.",
	"delete_error" => "There was a problem deleting this SemesterHasSubject. Please try again.",
	"not_found" => "That SemesterHasSubject does not exist.",
	"update_error" => "There was a problem updating this SemesterHasSubject. Please try again.",
	],
	],
	"frontend" => [
	"auth" => [
