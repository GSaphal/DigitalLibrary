...
return [
	...
	"semesterhassubjects" => [
	"all" => "All SemesterHasSubjects",
	"create" => "Create SemesterHasSubject",
	"edit" => "Edit SemesterHasSubject",
	"management" => "SemesterHasSubject Management",
	"main" => "SemesterHasSubjects",
	],
	],
	"language-picker" => [
	"language" => "Language",
